...
Cada conteúdo pode ter `categoria` e `tipo_conteudo`. A mídia é uma camada separada.
...
## Taxonomia
- `data/taxonomia.json` concentra categorias, tipos de conteúdo e gêneros sugeridos.
- `core/filtros.js` filtra `categoria` e `tipo_conteudo` separadamente.
